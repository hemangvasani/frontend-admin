          ...
          <div>
            <div className="about-section">
              ...
              <Flex gap={0} justifyContent="flex-start" mb={5}>
                ...
                <p style={{ width: "90%" }}>+35929490318</p>
              </Flex>
              <Flex justifyContent="flex-start" mb={5}>
                ...
                <p style={{ width: "90%" }}>
                  EPEN is dedicated to advancing technological frontiers and
                  delivering impactful solutions. Based in Sofia, Bulgaria, our
                  firm operates at the nexus of innovation and precision, where
                  our commitment to excellence drives us to deliver superior
                  results.
                </p>
              </Flex>
            </div>
