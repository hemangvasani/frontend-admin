...
import { SET_MESSAGE_MASTER_SUB_SERVICES } from "../../store/subservices/subservicesActionTypes";
...
const EditClientDrawer: React.FC<Props> = ({ clientmain, isOpen, onClose }) => {
  ...
  //     setFieldValue(`${imageType}File`, file);
  //   }
  // };
  ...
  //       problemBgImage: "problembgimage",
  //       solutionImage: "solutionimage",
  //       solutionBgImage: "solutionbgimage",
  //       processImage: "processimage",
  //       outcomeImage: "outcomebgimage",
  //       callImage: "callimage",
  //     };
  //     const fieldName = fieldMapping[imageType];
  //     if (fieldName) {
  //       setFieldValue(fieldName, response.data._id);
  //     }
  //   } catch (error) {
  //     console.error("Error uploading image:", error);
  //     toast({
  ...
  //     toast({
  //       title: "Error",
  //       description: "Please fill in both heading and title",
  //       status: "error",
  //       duration: 3000,
  //       isClosable: true,
  //     });
  ...
  //         `keyFeatures[${index}][keydesc]`,
  //         feature.keydesc
  //       );
  //     });
  //     const payload = clientformData;
  //     if (clientmain?._id) {
  //       const data = { payload, _id: clientmain._id };
  //       dispatch({
  //         type: REQUEST_UPDATE_MASTER_OUR_CLIENTS,
  //         data,
  //         onSuccess: () => {
  //           dispatch({ type: SET_MASTER_OUR_CLIENTS });
  //           toast({
  ...
  const onSubmit = async (values: Record<string, any>) => {
    ...
    // Prepare components array for client story
    const components = [
      // client: "fghsdejufhsdeifds",
      // icon_image: values.image || "",
      {
        name: "hero_section",
        bgImage: uploadedImages?.heroBgImage || "",
      ...
      },
      {
        ...
        image: uploadedImages?.aboutImage || "",
        order: 1,
      },
      {
        ...
        image: uploadedImages?.problemImage || "",
        bgImage: uploadedImages?.problemBgImage || "",
        order: 2,
      },
      {
        name: "our_solution",
      ...
      },
      {
        ...
        bgImage: uploadedImages?.solutionBgImage || "",
        image: uploadedImages?.solutionImage || "",
      ...
      },
      {
        ...
        image: uploadedImages?.processImage || "",
      ...
      },
      {
        ...
        bgImage: uploadedImages?.outcomeImage || "",
        order: 6,
      },
      {
        name: "call_to_action",
        ...
        image: uploadedImages?.callImage || "",
        order: 7,
      },
    ];
      ...
      dispatch({
        ...
        onSuccess: (response: any) => {
          ...
          const clientStoryData = {
            ...
            icon_image: uploadedImages.mainIcon || "",
            components,
          };
  ...
  //     //   dispatch({
  //     //     type: REQUEST_UPDATE_MASTER_OUR_CLIENTS,
  //     //     data: { payload: clientformData, _id: clientmain._id },
  //     //     onSuccess: (clientData: any) => {
  //     //       // After client is updated, create/update client story
  //     //       createClientStory(clientmain._id, values);
  //     //     },
  //     //   });
  //     // } else {
  //     dispatch({
  ...
  //         // After client is created, create client story
  //         createClientStory(clientData._id, values);
  //       },
  //     });
  //     // }
  //   } catch (error) {
  ...
  // const createClientStory = (clientId: string, values: any) => {
  //   const storyPayload = {
  //     client: clientId,
  //     icon_image: uploadedImages.mainIcon,
  //     components: [
