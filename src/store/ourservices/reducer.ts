...
const ourservices = (state = initialState, action: Record<string, any>) => {
  switch (action.type) {
    ...
    case SUCCESS_CREATE_MASTER_OUR_SERVICES:
      ...
      masterOurServices: Array.isArray(state.masterOurServices)
          ? [...state.masterOurServices, action.payload]
          : [action.payload]
    // }
      };
...
//         busy: false,
//         message: "",
//         masterOurServices: Array.isArray(action.payload) ? action.payload : [],
//       };
...
//         message: "",
//         masterOurServices: Array.isArray(state.masterOurServices)
//           ? state.masterOurServices.filter(
//               (tutorial) => get(tutorial, "_id") !== action.payload
//             )
//           : []
//       };
...
//         message: "",
//         masterOurServices: Array.isArray(state.masterOurServices)
//           ? state.masterOurServices.map((mp) => {
//               return get(mp, "_id") === action.payload._id ? action.payload : mp;
//             })
//           : []
//       };
